...
{
    int rc;
    static volatile pthread_mutex_t *vmutex;
    vmutex = mutex;
    static volatile const struct timespec *vabstime;
    vabstime = abstime;
...
{
    int rc;
    static volatile pthread_cond_t *vcond;
    vcond = cond;
...
{
    int rc;
    static volatile pthread_rwlock_t *vrwlock;
    vrwlock = rwlock;
