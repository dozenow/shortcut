...
def compSlice (outputdir, strno, pid):
    return os.system("gcc -masm=intel -c -fpic -Wall -Werror "+outputdir+"/exslice" + strno + "." + pid + ".c.swp -o "+outputdir+"/exslice" + strno + "." + pid + ".o")
import glob
import string
...
# Run the pin tool to generate slice info and the recheck log
        ...
        input_asm_file = glob.glob(outputdir + '/exslice[123456789]*.*.c.swp')
