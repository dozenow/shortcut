...
TAINTSIGN fw_slice_addressing_check_two (ADDRINT ip, int base_reg1, uint32_t base_reg_size1, uint32_t base_reg_value1, uint32_t base_reg_u8, int index_reg1, uint32_t index_reg_size1, uint32_t index_reg_value1, uint32_t index_reg_u8, u_long mem_loc1,uint32_t mem_size1, uint32_t is_read1, 
